...
import me.projectx.needaticketqr.pojo.CheckWrapper;

public class TaskCheckTicket extends AsyncTask<String, Void, String> {
    private String url;
    private String hash;
    private String ticketKey;
    private InterfaceTaskDefault listener;
    public TaskCheckTicket (String url, String hash, String ticketKey, InterfaceTaskDefault listener) {
        this.url = url;
        this.hash = hash;
    ...
    private void postData (HttpURLConnection conn, String... params) {
        ...
        try {
            ...
            CheckWrapper aw = new CheckWrapper(ticketKey);
